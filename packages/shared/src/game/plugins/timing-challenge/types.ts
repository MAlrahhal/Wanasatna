...
/** Hidden anti-stall timeout for guess-time / stop-timer phases (not shown in UI). */
export const TIMING_CHALLENGE_GAMEPLAY_SAFETY_SECONDS = 5 * 60;
export const TIMING_CHALLENGE_GUESS_SECONDS = TIMING_CHALLENGE_GAMEPLAY_SAFETY_SECONDS;
export const TIMING_CHALLENGE_STOP_PHASE_SECONDS = TIMING_CHALLENGE_GAMEPLAY_SAFETY_SECONDS;
