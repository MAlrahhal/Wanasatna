...
const pages: Record<IntentSeoId, IntentSeoPage> = {
  friends: {
    ...
    recommended: [
      ...
      },
      {
        id: 'who-wrote-it',
        blurb:
          'كل واحد يكتب جملة، وبعدين تخمّنون الأسلوب. تصلح للمكالمة لأن الكتابة تتم على الجهاز.',
      },
      {
        id: 'imposter-draw',
      ...
      {
        id: 'fast-answer',
        blurb: 'لو القروب يبي حركة خفيفة: كل إجابة صحيحة تكسب نقاطاً حسب ترتيبها.',
      },
    ],
    faqs: [
      {
  ...
  gatherings: {
    ...
    chooserIntro: 'الشاشة الكبيرة تفيد للعرض. الأدوار المخفية والكتابة تحتاج جهاز لكل مشارك.',
