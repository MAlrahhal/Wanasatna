...
export default function PrivacyPage() {
  return (
    <main className="mx-auto w-full max-w-5xl px-4 py-10 sm:px-6 sm:py-12">
      ...
      >
        <p className="text-wanas-text-muted text-xs sm:text-sm">آخر تحديث: 1 سبتمبر 2026</p>
      </PageHero>
      ...
      <article className="mx-auto min-w-0 max-w-4xl space-y-5 sm:space-y-6">
        ...
        <section className={sectionClassName}>
          ...
          <div className={bodyClassName}>
            ...
            <p>
              تستخدم وناستنا منصة إدارة الموافقة من Google (<bdi dir="ltr">Google CMP</bdi>) للحصول على
              موافقة المستخدمين وإدارة اختياراتهم حيث تكون مطلوبة في المنطقة الاقتصادية الأوروبية والمملكة
              المتحدة وسويسرا. ويمكن للمستخدم إدارة موافقته أو تفضيلاته من خلال رسالة الموافقة التي توفرها
              Google عندما تكون متاحة.
            </p>
          </div>
        </section>
