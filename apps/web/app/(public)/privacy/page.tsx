...
export default function PrivacyPage() {
  return (
    <main className="mx-auto w-full max-w-5xl px-4 py-10 sm:px-6 sm:py-12">
      ...
      >
        <p className="text-wanas-text-muted text-xs sm:text-sm">آخر تحديث: 22 سبتمبر 2026</p>
      </PageHero>
      ...
      <article className="mx-auto min-w-0 max-w-4xl space-y-5 sm:space-y-6">
        ...
        <section className={sectionClassName}>
          <h2 className={headingClassName}>الملاحظات المرسلة من داخل الموقع</h2>
          <div className={bodyClassName}>
            <p>
              عند إرسال ملاحظة نحفظ النوع والنص الذي كتبته، ومكان الإرسال داخل التجربة، وقد نحفظ
              معرّف الغرفة الداخلي واسم اللعبة ومسار الصفحة ونوع الجهاز ومعلومات المتصفح المعتادة
              ووقت الإرسال. تساعد هذه البيانات المحدودة على فهم المشكلة أو الاقتراح.
            </p>
            <p>
              لا يطلب نموذج الملاحظات اسمًا أو بريدًا إلكترونيًا، ولا يحفظ عنوان الشبكة في سجل
              الملاحظة، ولا يرسل حالة اللعبة الكاملة أو الأدوار والكلمات والإجابات السرية.
            </p>
          </div>
        </section>

        <section className={sectionClassName}>
          <h2 className={headingClassName}>الإعلانات وتقنيات الأطراف الثالثة</h2>
          <div className={bodyClassName}>
            <p>
              تستخدم وناستنا <bdi dir="ltr">Google AdSense</bdi> لعرض الإعلانات. قد تستخدم Google
              وشركاؤها الإعلانيون ملفات تعريف الارتباط أو <bdi dir="ltr">localStorage</bdi> أو تقنيات
              مشابهة لعرض الإعلانات وقياس أدائها ومنع الاحتيال وإساءة الاستخدام وتحسين الخدمات الإعلانية.
            </p>
            <p>
              قد تكون الإعلانات مخصصة أو غير مخصصة بحسب موافقة المستخدم ومنطقته وإعدادات Google. وفي حدود
              ما تسمح به الموافقة والإعدادات المطبقة، قد تعالج Google وخدمات الإعلان التابعة لأطراف ثالثة
              معلومات عن الجهاز والمتصفح والشبكة، مثل عنوان بروتوكول الإنترنت (<bdi dir="ltr">IP</bdi>)
              والمعرّفات وبيانات التفاعل مع الإعلانات والموقع التقريبي.
            </p>
            <p>
              لا تتضمن وناستنا حاليًا منصة إدارة موافقة مستقلة داخل التطبيق. قد توفر Google أدوات موافقة
              أو تفضيلات إعلانية خاصة بها بحسب المنطقة وإعدادات الحساب، ويمكن مراجعة إعدادات الإعلانات لدى
              Google حيث تكون متاحة.
            </p>
          </div>
        </section>
        ...
        <section className={sectionClassName}>
          ...
          <div className={bodyClassName}>
            <p>
              ...
              حدود الطلبات والحماية من الإساءة عند الاتصال، وإنشاء الغرف ودخولها، والعودة، وإرسال
              الملاحظات، وتسجيل الحساب أو الدخول إليه. لا يضيف التطبيق هذا العنوان إلى سجلات
              المباريات أو الملاحظات أو أحداث المنتج أو جداول الحسابات.
            </p>
            <p>
        ...
        <section className={sectionClassName}>
          ...
          <ul className={listClassName}>
            ...
            <li>مراجعة الملاحظات والاقتراحات ومعالجة البلاغات التي يرسلها اللاعبون.</li>
          </ul>
        </section>
        ...
        <section className={sectionClassName}>
          ...
          <ul className={listClassName}>
            ...
            <li>
              <bdi dir="ltr">Google AdSense</bdi> لعرض الإعلانات وقياسها وإدارة الموافقة المرتبطة بها حيث
              تكون مطلوبة.
            </li>
            <li>
        ...
        <section className={sectionClassName}>
          ...
          <ul className={listClassName}>
            ...
            <li>
              ...
              المنتج أو الملاحظات. يمكن للإدارة حذف الملاحظات من لوحة الإدارة.
            </li>
          </ul>
        </section>
