...
/**
 * Visual runtime harness for Guessing Challenge Real3D.
 * Open /dev/guessing-challenge-scene?mode=1v1|2v2
 */
  ...
  const props: GuessingChallengeSceneProps = useMemo(() => {
    if (mode === '2v2') {
      return {
        ...
        opponents: [
          { playerId: 'o0', name: 'خالد', seat: 0, lookYaw: -0.2, lookPitch: -0.1 },
          { playerId: 'o1', name: 'علي', seat: 1, lookYaw: 0.1, lookPitch: 0.2 },
        ],
        opponentName: 'خالد',
        selfName: 'سارة',
