  ...
  return (
    <header className="relative rounded-[1.35rem] border border-violet-400/[0.16] bg-[linear-gradient(105deg,rgba(8,11,29,0.99),rgba(16,20,47,0.98),rgba(9,12,31,0.99))] text-white shadow-[0_16px_40px_rgba(4,7,22,0.38)] ring-1 ring-inset ring-white/[0.025]">
      <div className="flex min-h-20 items-center justify-between gap-3 px-3 py-3 sm:px-4 lg:gap-4 lg:px-5 lg:py-4">
        <div className="flex min-w-0 flex-col items-start gap-2.5 min-[430px]:flex-row min-[430px]:items-center sm:gap-3 lg:shrink-0">
          {showInvitationDetails ? (
            <div className="w-[10.5rem] shrink-0 rounded-2xl border border-violet-400/30 bg-[linear-gradient(145deg,rgba(36,31,70,0.8),rgba(14,18,42,0.92))] px-4 py-2.5 shadow-[0_8px_24px_rgba(76,29,149,0.16),inset_0_1px_0_rgba(255,255,255,0.05)] ring-1 ring-inset ring-violet-300/[0.06] sm:w-[11.5rem]">
              <p className="text-[11px] font-semibold tracking-wide text-violet-100/55">
                رمز الغرفة
              </p>
              <p
                dir="ltr"
                className="mt-0.5 whitespace-nowrap font-mono text-xl font-black tracking-[0.24em] text-white drop-shadow-[0_1px_5px_rgba(255,255,255,0.12)] sm:text-2xl"
              >
                {roomCode}
              </p>
            </div>
        ...
        <div
          ...
          className={cn(
            'absolute inset-x-2 top-[calc(100%+0.5rem)] z-30 flex-col gap-2 rounded-2xl border border-violet-400/[0.16] bg-[#090d22]/[0.98] p-3 shadow-[0_18px_40px_rgba(2,4,15,0.5)] lg:static lg:z-auto lg:flex lg:min-w-0 lg:flex-1 lg:flex-row lg:flex-wrap lg:items-center lg:justify-end lg:bg-transparent lg:p-0 lg:shadow-none',
