...
import { registerGuessingChallengePlugin } from './guessing-challenge/index.js';
...
export function registerAllGamePlugins(): void {
  ...
  registerJudgePlugin();
  registerGuessingChallengePlugin();
}
...
export { registerGuessingChallengePlugin } from './guessing-challenge/index.js';
